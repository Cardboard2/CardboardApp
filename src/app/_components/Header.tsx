  ...
  return (
    <header className="bg-amber-400 w-full bg-opacity-90">
      ...
      <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-amber-400 text-amber-950 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="/" className="-m-1.5 p-1.5">
              <span className="sr-only">Cardboard</span>
              <div className='w-10 h-10'><CardboardLogo/></div>
            </a>
            <button
              type="button"
