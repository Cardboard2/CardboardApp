              ...
              <Switch.Group as="div" className="flex items-center">
                <Switch
                  ...
                  className={classNames(
                    ...
                    'relative inline-flex h-8 w-14 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-amber-700 focus:ring-offset-2'
                  )}
                >
                  <span
                    aria-hidden="true"
                    className={classNames(
                      ...
                      'pointer-events-none inline-block h-7 w-7 transform rounded-full bg-amber-700 shadow ring-0 transition duration-200 ease-in-out'
                    )}
                  />
                </Switch>
            ...
            <div className="isolate -mt-16 grid max-w-sm grid-cols-1 gap-y-16 divide-y divide-gray-700 sm:mx-auto lg:-mx-8 lg:mt-0 lg:max-w-none lg:grid-cols-3 lg:divide-x lg:divide-y-0 xl:-mx-4">
              {tiers.map((tier) => (
                <div key={tier.id} className="pt-16 lg:px-8 lg:pt-0 xl:px-14">
                  ...
                  <button
                    onClick={() => SelectTierForPayment(annualPayment, tier, props.paymentState)}
                    className="mt-6 block duration-300 rounded-md bg-amber-700 px-3 py-2 text-center text-sm active:opacity-80 font-semibold leading-6 text-white shadow-sm hover:bg-amber-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"
                  >
                    Choose plan
                  </button>
