...
export const tiers: tier[] = [
  {
    ...
    description:
      "Everything necessary to get started. We can be nice if we wanted to.",
    features: ["Free 10 MB storage just for you ❤️"],
  },
  {
    ...
    priceId: {
      monthly: "price_1O95MAIEdHdbj4cnIlR0sIgM",
      annually: "price_1O95TNIEdHdbj4cn850p9f5d",
    },
    description: "When you need some serious storage for them 🐈‍⬛ pics.",
    features: [
      "100 MB of on-demand storage",
  ...
  },
  {
    ...
    priceId: {
      monthly: "price_1O98rkIEdHdbj4cndIUjsLeR",
      annually: "price_1O98rkIEdHdbj4cnQRHrt7DY",
    },
    description: "You are an instagram model or something, idk. You do you.",
    features: [
      "A massive 500 MB of storage 😱😱",
